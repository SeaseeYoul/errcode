// Package errcode A simple test helper
...
// temporary disable ecode related cases

// 期望为 OK status
// func ExpectOkStatus(t *testing.T, status ecode.Codes, msg ...string) {
// 	if ret := test(defaultSkip+1,
// 		fmt.Sprintf("Expected: OK, actual:  '%v'", status),
// 		func() bool {
// 			return ecode.CheckOk(status)
// 		},
// 		msg...); ret != "" {
// 		if testMode {
// 			testBuff.Write([]byte(ret))
...
// func ExpectNonOkStatus(t *testing.T, status ecode.Codes, msg ...string) {
// 	if ret := test(defaultSkip+1,
// 		fmt.Sprintf("Expected: Not OK, actual:  '%v'", status),
// 		func() bool {
// 			return !ecode.CheckOk(status)
// 		},
// 		msg...); ret != "" {
